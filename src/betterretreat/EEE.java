...
public class EEE {
    ...
    public static boolean canBuildSRPHere(MapLocation me, boolean allowRepair) throws Exception {
        ...
        int total = 0;
        int canSee = 0;
        if (G.rc.canSenseLocation(me) && G.rc.senseMapInfo(me).getMark() == PaintType.ALLY_SECONDARY) {
            total++;
            canSee++;
        }
        ...
        if (G.rc.canSenseLocation(me.add(Direction.NORTHEAST)) && G.rc.senseMapInfo(me.add(Direction.NORTHEAST)).getMark() == PaintType.ALLY_SECONDARY) {
            total++;
            canSee++;
        }
        ...
        if (G.rc.canSenseLocation(me.add(Direction.NORTHWEST)) && G.rc.senseMapInfo(me.add(Direction.NORTHWEST)).getMark() == PaintType.ALLY_SECONDARY) {
            total++;
            canSee++;
        }
        ...
        if (G.rc.canSenseLocation(me.add(Direction.SOUTHEAST)) && G.rc.senseMapInfo(me.add(Direction.SOUTHEAST)).getMark() == PaintType.ALLY_SECONDARY) {
            total++;
            canSee++;
        }
        ...
        if (G.rc.canSenseLocation(me.add(Direction.SOUTHWEST)) && G.rc.senseMapInfo(me.add(Direction.SOUTHWEST)).getMark() == PaintType.ALLY_SECONDARY) {
            total++;
            canSee++;
        }
