...
public class Mopper {
	...
	public static void exploreMoveScores() throws Exception {
        ...
        if (bestEmpty == null && bestBot == null) {
            ...
            if (bestLoc != null) {
                dir = Motion.bug2Helper(G.me, bestLoc, Motion.TOWARDS, 0, 0);
                G.rc.setIndicatorLine(G.me, bestLoc, 0, 0, 100);
            }
            else {
    ...
    //basically the same as exploreAttackScores but with extra bonus for stealing 5 paint
