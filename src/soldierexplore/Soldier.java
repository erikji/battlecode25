...
public class Soldier {
    ...
    public static final int TOWER_VISIT_TIMEOUT = 4000;
    ...
    public static final int SRP_MIN_PAINT = 75;
    ...
    public static int lastSrpExpansion = -SRP_EXPAND_TIMEOUT + SPAWN_SRP_MIN_ROUNDS;
