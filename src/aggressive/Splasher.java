...
public class Splasher {
    ...
    public static void exploreMoveScores() throws Exception {
        moveScores = Motion.defaultMicro
                .micro(Motion.bug2Helper(G.me, Motion.exploreRandomlyLoc(), Motion.TOWARDS, 0, 0), Motion.exploreLoc);
    }
    ...
    public static void attackMoveScores() throws Exception {
        moveScores = Motion.defaultMicro.micro(Motion.bug2Helper(G.me, attackTarget, Motion.TOWARDS, 0, 0),
                attackTarget);
    }
        ...
        if (attackTarget.x == -1) {
            ...
            for (int i = POI.numberOfTowers; --i >= 0;) {
                ...
                if (triedAttackTargets.indexOf("" + (char) i) != -1) {
                    // if (!(G.round <= VISIT_TIMEOUT || G.getLastVisited(loc.x, loc.y) +
                    // VISIT_TIMEOUT < G.round)) {
                    weight -= 1000;
