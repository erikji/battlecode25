...
public class Tower {
    ...
    public static double doubleSpawnedSoldiers = 2.0 / 3.0 + 1e-5;
    public static double doubleSpawnedSplashers = -1.0 / 3.0;
    public static double doubleSpawnedMoppers = -1.0 / 3.0 + 1e-6;
