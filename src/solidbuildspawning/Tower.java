...
public class Tower {
    ...
    public static final double TOW_SPAWN_SOLDIER_WEIGHT = 4;
    public static final double TOW_SPAWN_SPLASHER_WEIGHT = 0.99;
    public static final double TOW_SPAWN_MOPPER_WEIGHT = 1;
